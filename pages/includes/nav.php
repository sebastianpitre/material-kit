...
<div class="container position-sticky z-index-sticky top-0"><div class="row"><div class="col-12">
      <nav class="navbar navbar-expand-lg  blur border-radius-xl top-0 z-index-fixed shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
        ...
        <a href="./especies.php" class="dropdown-item border-radius-md">
          <span>Especies</span>
        </a>
        <a href="./areas.php" class="dropdown-item border-radius-md">
          <span>Areas</span>
        </a>
        ...
        <a href="../pages/crud/index.php" class="dropdown-item border-radius-md">
          <span>Registrar aves
          </span>
        </a>
      </div>
